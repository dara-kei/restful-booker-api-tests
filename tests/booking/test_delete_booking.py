...
def test_delete_booking(api_client, create_booking, token):
...
def test_delete_booking_with_invalid_id(api_client, create_booking, token, suffix):

    invalid_id = f"{create_booking['bookingid']}{suffix}"
